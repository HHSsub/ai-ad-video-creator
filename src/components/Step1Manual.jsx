...
자유롭게 작성하세요. AI가 이해하고 최적의 영상을 생성합니다."
        ...
        <div className="flex items-center justify-between pt-6 border-t border-gray-700 mt-8">
          ...
          {/* 기존 다음 버튼 */}
          <button
            className="btn-submit px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 disabled:from-gray-700 disabled:to-gray-800 disabled:text-gray-500 disabled:opacity-70 text-white rounded-lg transition-all duration-200 font-medium disabled:cursor-not-allowed shadow-lg"
